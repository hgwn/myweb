...
<link href="${contextPath}/styles/dwz/themes/azure/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${contextPath}/styles/dwz/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${contextPath}/styles/dwz/themes/css/main.css" rel="stylesheet" type="text/css" media="screen"/>
...
<link href="${contextPath}/styles/treeTable/themes/azure/treeTable.css" rel="stylesheet" type="text/css" />
...
<script src="${contextPath}/styles/jquery/jquery.chained.min.js" type="text/javascript"></script>
...
<script>
  /* EXAMPLE */
  DD_belatedPNG.fix('img,.png_bg,.accordionHeader h2,.buttonContent');
...
<script src="${contextPath}/styles/dwz/js/dwz.combox.js" type="text/javascript"></script>
<%-- 下拉联动JS --%>
<script src="${contextPath}/styles/chained/jquery.chained.remote.js" type="text/javascript"></script>
<%-- 自定义JS --%>
...
<script src="${contextPath}/styles/dwz/js/Hcustomer.js" type="text/javascript"></script>
<script src="${contextPath}/styles/dwz/js/dwz.stable02.js" type="text/javascript"></script>
<script src="${contextPath}/styles/dwz/js/dwz.ui.js" type="text/javascript"></script>
<script src="${contextPath}/styles/dwz/js/dwz.database.js" type="text/javascript"></script>
<script src="${contextPath}/styles/dwz/js/dwz.checkbox.js" type="text/javascript"></script>
...
<div id="layout">
	<div id="header">
		<div class="headerNav">
			...
			<ul class="nav">
				<span class="fl block">[</span>
				<span class="fl block">用户名：<b>${login_user.realname }</b></span>
				...
				<li><a href="${contextPath}/management/index/updatePwd" target="dialog" mask="true" width="550" height="250">修改密码</a></li>
	...
	<div id="leftside">
		...
		<div id="sidebar">
			<div class="toggleCollapse"><h2>菜单</h2><div class="png_bg">collapse</div></div>
			<div class="accordion" fillSpace="sideBar">
				<c:forEach var="level1" items="${menuModule.children }">
					<div class="accordionHeader">
						<h2><span class="icon_${level1.sn }">Folder</span>${level1.name }</h2>
					</div>
			...
			<div class="navTab-panel tabsPageContent layoutBox">
				<div class="page unitBox">
					<div class="accountInfo">
						<div class="right">
							<p>今天是：<fmt:formatDate value="<%=new Date() %>" pattern="yyyy-MM-dd EEEE"/></p>
						</div>
						<p style="font-size:15px; letter-spacing:1px;"><span>${login_user.realname }</span>，欢迎您使用邮政业务卡支付系统！</p>
					</div>
					<div class="pageFormContent" layouth="80">
					<div class="Myuser_info">
						<h3><span class="userInfo_tittle">基本信息</span></h3>
						<dl>
							<dt>登录名称：</dt>
						...
						<dl>
							<dt>创建时间：</dt>
							<dd><span class="unit"><fmt:formatDate value="${login_user.createdTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span></dd>
						</dl>
						<dl>
							<dt>可用状态：</dt>
							<dd><span class="unit">${(login_user.status == "E")? "可用":"停用"}</span></dd>
						</dl>
						<dl>
							<dt>所属机构：</dt>
							<dd><span class="unit">${login_user.organization.name }
							</span></dd>
						</dl>
					</div>
					</div>
...
<div id="footer">2014中国邮政集团&nbsp;&nbsp;Copyright &copy;&nbsp;2014&nbsp;All Rights Reserve.&nbsp;&nbsp;<span style="color:#999;">版本号：cps-0.18.0</span></div>
</body>
</html>