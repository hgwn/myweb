...
<script type="text/javascript">
	function selectBack(id,name){
		document.getElementById("internalMernoId_internal2").value=id;
		document.getElementById("internalMernoName_internal2").value=name;
		$(".h-cleanBtn-internalMerno2").css("display","block");
		$("#close_merno").click();
