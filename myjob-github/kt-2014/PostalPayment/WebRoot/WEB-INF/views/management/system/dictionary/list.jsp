...
<form method="post" action="${contextPath }/management/system/dictionary/list?id=${pDictionary.id}" onsubmit="return navTabSearch(this)">
	<div class="pageHeader">
		<div class="searchBar">
			<ul class="searchContent" style="height:auto; width:90%; position:relative;">
				<li class="widthcols3">
				<c:choose>
	...
	<div class="panelBar">
		<ul class="toolBar">
			...
			<shiro:hasPermission name="Dictionary:save">
				<li><a iconClass="book_add" target="dialog" mask="true" width="600" height="350" rel="Dictionary_save" href="${contextPath }/management/system/dictionary/create"><span>添加字典主题</span></a></li>
			</shiro:hasPermission>
			<shiro:hasPermission name="Dictionary:edit">
				<li><a iconClass="book_edit" target="dialog" mask="true" width="600" height="350" rel="Dictionary_edit" href="${contextPath }/management/system/dictionary/update/{slt_uid}"><span>编辑字典主题</span></a></li>
			</shiro:hasPermission>
