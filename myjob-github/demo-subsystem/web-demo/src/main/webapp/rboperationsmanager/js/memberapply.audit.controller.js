 ...
 */
/*商户信息审核*/
operationsModule.controller("memberapply_auditCtr",["$http","$scope","$state","$stateParams","$modal","$alert","operationsmanagerService",function($http,$scope,$state,$stateParams,$modal,$alert,operationsmanagerService){
    //定义提交数据
