angular.module('headQuartersOrders.Service',[])
    .factory('headQuartersOrdersService',['$http',function($http){
        var factory = {};
        var payData = {};
        ...
        var getExternalHeadQuartersOrdersUrl = '/jsbweb/enterprise/headquartersorders/getExternalHeadQuartersOrders.do';
        var paidOrdersUrl = '/jsbweb/enterprise/headquartersorders/paidOrders.do';
        var getRefinedOrdersUrl = '/jsbweb/baseline/orders/getRefinedOrders.do';
        var auditOrdersUrl = '/jsbweb/baseline/orders/auditOrders.do';
        var getSessionUrl = '/jsbweb/base/getSession.do'; 
        
        factory.getSession = function(){
        	return getSessionUrl;
        };
        factory.getAuditOrdersUrl = function(){
        	return auditOrdersUrl;
        };
        factory.getRefinedOrders = function(){
        	return getRefinedOrdersUrl;
        };
        factory.paidOrders = function(){
        	return paidOrdersUrl;
        };
        factory.getExternalHeadQuartersOrders = function(){
        	return getExternalHeadQuartersOrdersUrl;
        };
