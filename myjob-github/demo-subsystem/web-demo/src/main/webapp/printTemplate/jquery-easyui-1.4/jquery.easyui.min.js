...
},beforePageText:"第",afterPageText:"页 共 {pages} 页",displayMsg:"显示 {from} 到 {to} 条记录;共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"该项必填.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_422,blur:_426,mouseenter:_42a,mouseleave:_42d,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请输入有效的邮箱(如:123@163.com)."},url:{validator:function(_44d){
...
},message:"请输入有效的URL."},length:{validator:function(_44e,_44f){
...
return _452=="true";
},message:"请修复此字段."}},onBeforeValidate:function(){
